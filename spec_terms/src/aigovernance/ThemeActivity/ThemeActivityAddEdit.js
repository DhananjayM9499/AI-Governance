...
const ThemeActivityAddEdit = () => {
  ...
  useEffect(() => {
    if (themeactivityid) {
      axios
        .get(API.VIEW_THEMEACTIVITY_API(themeactivityid))
  ...
  const handlSubmit = (e) => {
    ...
    if (!themename) {
      ...
      if (!themeactivityid) {
        axios
          .post(API.ADD_THEMEACTIVITY_API, {
            themename,
            phase,
            activitygroup,
            activity,
        ...
        axios
          .put(API.UPDATE_THEMEACTIVITY_API(themeactivityid), {
            themename,
            phase,
            activitygroup,
            activity,
        ...
        <div>
          ...
          >
            ...
            {phaseTheme.map((phasetheme) => (
              <option key={phasetheme.activitygroupid} value={phasetheme.phase}>
                {phasetheme.phase}
              </option>
            ))}
          </select>
